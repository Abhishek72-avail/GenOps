...
router.post("/auth/login", async (req, res): Promise<void> => {
  ...
  res.json({
    user: { id: user.id, username: user.username, email: user.email, sheetLink: user.sheetLink },
    message: "Logged in"
  });
});
...
router.get("/auth/me", async (req, res): Promise<void> => {
  ...
  res.json({ id: user.id, username: user.username, email: user.email, sheetLink: user.sheetLink });
});
