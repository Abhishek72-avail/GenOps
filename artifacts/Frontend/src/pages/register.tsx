            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium" style={{ color: "#374151" }}>Google Sheets Link or ID</FormLabel>
                      <FormControl>
                        <Input placeholder="Enter Google Sheet URL or ID" className="h-10 bg-white border-gray-300" data-testid="input-sheet-link" {...field} />
                      </FormControl>
